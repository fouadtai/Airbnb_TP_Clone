      ...
      <div class="card card-detail">
        ...
        <div class="infos-equipements p-4">
          <div class="card-body">
            ...
            <p class="card-text">Type du logement : <?= $logement->type_logement->label ?></p>
            <p class="card-text price">Prix : <span id="nightPrice" class="price1"><?= $logement->price_per_night ?> </span>€ / nuit </p>
            <p class="card-text">M² du logement : <?= $logement->Taille ?> m² </p>
            ...
            <p class="card-text">Nombre de voyageurs possible : <?= $logement->nb_traveler ?> </p>
          </div>
          <div class="equipements">
            <p class="fw-bold">Equipements inclus dans logement :</p>
